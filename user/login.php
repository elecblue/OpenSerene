...
<div id="container">
	...
	<div class="sectionBox">
		...
		<table>
			<tr>
				<td>Username:</td>
				<td><input type='text' size='15' maxlength='25' name='username' class="smtext" />
				</td>
			</tr>
			<tr>
				<td>Password:</td>
				<td><input type='password' size='15' maxlength='25' name='password' class="smtext" />
				</td>
			</tr>
			<tr>
				<td align="center">
					<input type="submit" value="Login" class="submit" class="submit" />
				</td>
			</tr>
		</table>
		</form>
