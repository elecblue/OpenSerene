...
<head>
	<title>Post Editor &mdash; <?= "$siteName";?> | OpenSerene</title>
...
<div id="container">
	<h1 class="section">Post Management</h1>
	...
	<?php if($_GET == null){
		...
		while($r=mysql_fetch_array($result)) {
			extract($r); ?>
	<div class="sectionBox">
		<h2 class="subsect"><?php echo "$title"; ?></h2>
		<p><?php nl2br_skip_html("$message");?></p>
		<div style="margin-top: 10px; font-weight: bold;"><a href="editnews.php?cmd=edit&id=<?php echo "$id"; ?>">Edit</a> |
		<a href="editnews.php?cmd=delete&id=<?php echo "$id"; ?>">Delete</a></div>
	</div>
	<?php } 
	} ?>
	<?php if($_GET["cmd"]=="edit" || $_POST["cmd"]=="edit"){
	...
	<form action="editnews.php" method="post">
		...
		<input class="title" type="text" name="title" value="<?php echo $myrow["title"] ?>" size="71" /><br />
		<textarea name="message" rows="15" cols="100"><?php echo $myrow["message"] ?></textarea><br />
		<!-- User Posted -->
